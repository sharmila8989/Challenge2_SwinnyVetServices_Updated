...
namespace SwinnyVetServices_WebAPI.Controllers
{
    public class PetsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "petId,petName,petType,ownerId")] Pet pet)
        {
            ...
            ViewBag.ownerId = new SelectList(db.Owners, "ownerId", "ownerSurname", pet.ownerId);
            return View(pet);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "petId,petName,petType,ownerId")] Pet pet)
        {
            if (ModelState.IsValid)
            {
