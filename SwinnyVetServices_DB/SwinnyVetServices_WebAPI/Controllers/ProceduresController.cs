...
namespace SwinnyVetServices_WebAPI.Controllers
{
    public class ProceduresController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "procedureId,procedureDescription,procedurePrice")] Procedure procedure)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "procedureId,procedureDescription,procedurePrice")] Procedure procedure)
        {
            if (ModelState.IsValid)
            {
